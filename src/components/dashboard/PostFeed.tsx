        ...
        {posts.map((post) => {
          ...
          return (
            <a 
              ...
              className="glass group flex flex-col justify-between rounded-xl p-5 transition-all duration-300 hover:border-indigo-500/30 hover:bg-white/10"
            >
              <div>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 border-t border-white/5 pt-4 text-sm text-slate-400">
                {post.creator && (
